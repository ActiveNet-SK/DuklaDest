...
function initializeMap() {
    ...
    var popis = '<div class="mapa_okno"><a href="detail_tnv.html?id=5" class="mapa_odkaz" onClick=\'presmeruj("detail_tnv.html?id=5")\'>' +
        '<div class="mapa_obrazok"  ><img src="img/logo_stvorec.png" alt="aaa" style="margin-left:1em;"></div>' +
        '<div class="mapa_popis"> <h3 class="mapa_nadpis">aaasd</h3>' +
        '<p class="mapa_popis">aaadf asdf asdf</p></div> </a></div> ';
   ...
   /*  L.marker([49.3908644, 21.85], { icon: cervena }).addTo(map)
         .bindPopup('<div class="mapa_okno"><div class="mapa_obrazok"><img src="img/logo_stvorec.png"  class="mapa_popis" alt="poklad" /></div><div class="mapa_popis"><h3 class="mapa_nadpis">poklad</h3><p class="mapa_popis">blablabla æöËùû˝·ÌÈ asdasd asdnasdas iasbdaksdj asbdaskd basbd asdba</p>  <a href="#" class="mapa_odkaz">Viac</a></div>')
         ;
    ...
    tnvDB.transaction(function (transaction) {
        transaction.executeSql(sql, [], function (tx, results) {
            ...
            for (i = 0; i < len; i++) {
                ...
                var img = ' <div class="mapa_obrazok" ><img src="img/logo_stvorec.png" alt="' + nazov + '" style="margin-left:1em;"></div>';
                if (results.rows.item(i).obrazky.length <= 2) {
                    img = ' <div class="mapa_obrazok" ><img src="img/logo_stvorec.png" alt="' +  nazov + '" style="margin-left:1em;"></div>';
                ...
                if (results.rows.item(i).obrazky.length <= 2) {
                    ...
                    img = ' < div class="mapa_obrazok" id="' + idecko + '" ><img src="img/logo_stvorec.png" alt="' + results.rows.item(i).strana + nazov + '" style="margin-left:1em;"></div>';
